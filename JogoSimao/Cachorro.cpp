...
namespace Entidades{
	namespace Personagens{
		Cachorro::Cachorro(sf::Vector2f pos, Listas::ListaEntidades* lista, Personagem* jogador, Personagem* dono)
			:Inimigo(pos, lista, jogador), pDono(dono), velocidadeCacando(4), velocidadeSeguindo(3)
		{
			/**
